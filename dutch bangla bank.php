           ...
           if(isset($_POST['submit']))
            {
              ...
              if("$name" == "" or "$address" == "" or "$contact" == "" or "$product_code" == "" or "$quantity" == "" or "$transaction" == "")
              {
                ...
                {
                    $sql = "INSERT INTO  rocket_order(name, address, contact_number, transaction_id, product_code, quantity)
                VALUES ('$name', '$address', '$contact', '$transaction', '$product_code', '$quantity')";
